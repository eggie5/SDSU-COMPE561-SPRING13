...
namespace Lab3BasketBallStats
{
	...
	[global::System.Data.Linq.Mapping.DatabaseAttribute(Name="BasketballStats")]
    ...
    partial void DeleteStatistic(Statistic instance);
		...
		public DataClasses1DataContext() : 
				base(global::Lab3BasketBallStats.Properties.Settings.Default.BasketballStatsConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void Onleague_nameChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_league_name", DbType="NChar(10)")]
	...
	public partial class Game : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private int _visiting_team_id;
		
		private System.Nullable<int> _home_team_score;
		
		private System.Nullable<int> _visitin_team_score;
    ...
    partial void Onvisiting_team_idChanging(int value);
    ...
    partial void Onvisitin_team_scoreChanging(System.Nullable<int> value);
    partial void Onvisitin_team_scoreChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_visiting_team_id", DbType="Int NOT NULL")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_visitin_team_score", DbType="Int")]
		public System.Nullable<int> visitin_team_score
		{
			get
			{
				return this._visitin_team_score;
			}
			set
			{
				if ((this._visitin_team_score != value))
				{
					this.Onvisitin_team_scoreChanging(value);
					this.SendPropertyChanging();
					this._visitin_team_score = value;
					this.SendPropertyChanged("visitin_team_score");
					this.Onvisitin_team_scoreChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Game_Statistic", Storage="_Statistics", ThisKey="Id", OtherKey="game_id")]
		public EntitySet<Statistic> Statistics
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Team_Game1", Storage="_Team2", ThisKey="visiting_team_id", OtherKey="Id", IsForeignKey=true)]
		public Team Team2
		{
			get
			{
			...
			set
			{
							...
							|| (this._Team2.HasLoadedOrAssignedValue == false)))
				{
					...
					{
						this._visiting_team_id = default(int);
					}
	...
	public partial class Statistic : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _shot_attempts;
    ...
    partial void Onshot_attemptsChanging(System.Nullable<int> value);
    partial void Onshot_attemptsChanged();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_shot_attempts", DbType="Int")]
		public System.Nullable<int> shot_attempts
		{
			get
			{
				return this._shot_attempts;
			}
			set
			{
				if ((this._shot_attempts != value))
				{
					this.Onshot_attemptsChanging(value);
					this.SendPropertyChanging();
					this._shot_attempts = value;
					this.SendPropertyChanged("shot_attempts");
					this.Onshot_attemptsChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Game_Statistic", Storage="_Game", ThisKey="game_id", OtherKey="Id", IsForeignKey=true)]
		public Game Game
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="Player_Statistic", Storage="_Player", ThisKey="player_id", OtherKey="Id", IsForeignKey=true)]
